...
%>
       ...
       con=dbcon.create();
       PreparedStatement ps=con.prepareStatement("SELECT * FROM `train`.`hotelnames` WHERE location LIKE  '"+location+"'  ");
     ...
     <tr class="table-secondary">
      ...
      <td style="text-align: center;"><a href="hotelbookpage.jsp"><%= rs.getString(3) %></a></td>
