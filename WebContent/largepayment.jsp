...
<div class="container">
	<div class="center">
		<div class="payment-box">
			...
			<form class="form" action="largeend.jsp" method="post">
...
<input value="<%=anumber%>"type="hidden"  name="anumber">
...
<input value="<%=indate%>"type="hidden"  name="indate">
<input value="<%=outdate%>"type="hidden"  name="outdate">
<input value="<%=room%>"type="hidden"  name="room">
