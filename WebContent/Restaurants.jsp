...
%>
       ...
       con=dbcon.create();
       PreparedStatement ps=con.prepareStatement("SELECT * FROM `train`.`findrestaurant` WHERE location LIKE  '"+location+"'  ");
     ...
     <tr class="table-secondary">
      ...
      <td style="text-align: center;"><a href="foodorder.jsp"><%= rs.getString(3) %></a></td>
