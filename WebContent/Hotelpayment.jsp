...
String from=request.getParameter("food");
...
<div class="container">
	<div class="center">
		<div class="payment-box">
			...
			<form class="form" action="hotelend.jsp" method="post">
			
			<input type="hidden" value="<%=from %>" name="food" >
			<input type="hidden" value="<%=quan %>" name="quan" >
