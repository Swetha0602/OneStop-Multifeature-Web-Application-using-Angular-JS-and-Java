...
<%String fodname=session.getAttribute("foodname").toString(); 
%>
       ...
       con=dbcon.create();
       PreparedStatement ps=con.prepareStatement("SELECT * FROM `train`.`fooddetails` WHERE Foodname='"+fodname+"'");
     ...
     <td style="text-align: center;"><%=rs.getString(2)%></td>
      <td style="text-align: center;"><%= rs.getString(3) %></td>
       ...
       <td style="text-align: center;"><%= rs.getString(3)%></td>
       <td style="text-align: center;"><%= rs.getString(3)%></td>
      <td style="text-align: center;"><a href="" ><button>Pay</button></td></a>
